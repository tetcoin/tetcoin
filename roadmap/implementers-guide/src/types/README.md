...
digraph {
    ...
    Id [label="tetcoin_parachain::primitives::Id"]
    CollatorId [label="tetcoin_primitives::v0::CollatorId"]
    ...
    TransientValidationData:balance -> "tetcoin_core_primitives::v1::Balance":w
    ...
    CandidateCommitments:upward_messages -> "tetcoin_parachain::primitives::UpwardMessage":w
    CandidateCommitments:horizontal_messages -> "tetcoin_core_primitives::v1::OutboundHrmpMessage":w
    CandidateCommitments:head_data -> HeadData:w
    CandidateCommitments:horizontal_messages -> "tetcoin_parachain::primitives::Id":w
    CandidateCommitments:new_validation_code -> "tetcoin_parachain::primitives::ValidationCode":w
    ...
    PoV:block_data -> "tetcoin_parachain::primitives::BlockData":w
    ...
    BackedCandidate:validity_votes  -> "tetcoin_primitives:v0:ValidityAttestation":w

    HeadData [label = "tetcoin_parachain::primitives::HeadData"]
    ...
    ValidatorId [label = "tetcoin_primitives::v0::ValidatorId"]
    AuthorityDiscoveryId [label = "tp_authority_discovery::AuthorityId"]
    ValidatorIndex [label = "tetcoin_primitives::v0::ValidatorIndex"]
...
digraph {
    ...
    RelayChainBlockNumber [label = "tetcoin_core_primitives::BlockNumber"]
    ...
    OutboundHrmpMessage [label = "tetcoin_core_primitives::OutboundHrmpMessage"]
}
```
