...
//! `noble-staking` to compute the rewards.
//!
//! Based on https://w3f-research.readthedocs.io/en/latest/tetcoin/Token%20Economics.html
...
use noble_staking::SessionInterface;

/// The amount of era points given by backing a candidate that is included.
pub const BACKING_POINTS: u32 = 20;

/// Rewards validators for participating in parachains with era points in noble-staking.
pub struct RewardValidatorsWithEraPoints<C>(tetcore_std::marker::PhantomData<C>);

fn reward_by_indices<C, I>(points: u32, indices: I) where
	C: noble_staking::Config,
