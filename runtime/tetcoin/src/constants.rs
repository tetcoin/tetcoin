...
pub mod currency {
	...
	pub const TETS: Balance = 1_000_000_000_000;
	pub const DOLLARS: Balance = TETS / 100;       // 10_000_000_000
...
pub mod fee {
	...
	impl WeightToFeePolynomial for WeightToFee {
		...
		fn polynomial() -> WeightToFeeCoefficients<Self::Balance> {
			// in Tetcoin, extrinsic base weight (smallest non-zero weight) is mapped to 1/10 CENT:
