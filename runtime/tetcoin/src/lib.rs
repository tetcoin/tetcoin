...
impl noble_democracy::Config for Runtime {
	...
	type ExternalOrigin = fabric_system::EnsureOneOf<AccountId,
		noble_collective::EnsureProportionAtLeast<_1, _2, AccountId, CouncilCollective>,
		fabric_system::EnsureRoot<AccountId>,
	>;
	/// A 60% super-majority can have the next scheduled referendum be a straight majority-carries vote.
	type ExternalMajorityOrigin = fabric_system::EnsureOneOf<AccountId,
		noble_collective::EnsureProportionAtLeast<_3, _5, AccountId, CouncilCollective>,
		fabric_system::EnsureRoot<AccountId>,
	>;
	/// A unanimous council can have the next scheduled referendum be a straight default-carries
	/// (NTB) vote.
	type ExternalDefaultOrigin = fabric_system::EnsureOneOf<AccountId,
		noble_collective::EnsureProportionAtLeast<_1, _1, AccountId, CouncilCollective>,
		fabric_system::EnsureRoot<AccountId>,
	>;
	/// Two thirds of the technical committee can have an ExternalMajority/ExternalDefault vote
	/// be tabled immediately and with a shorter voting/enactment period.
	type FastTrackOrigin = fabric_system::EnsureOneOf<AccountId,
		noble_collective::EnsureProportionAtLeast<_2, _3, AccountId, TechnicalCollective>,
		fabric_system::EnsureRoot<AccountId>,
	>;
	type InstantOrigin = fabric_system::EnsureOneOf<AccountId,
...
impl<C> fabric_system::offchain::SendTransactionTypes<C> for Runtime where Call: From<C> {
...
impl claims::Config for Runtime {
	...
	type MoveClaimOrigin = noble_collective::EnsureProportionAtLeast<_3, _4, AccountId, CouncilCollective>;
...
construct_runtime! {
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		RandomnessCollectiveFlip: noble_randomness_collective_flip::{Module, Storage} = 31,
		Scheduler: noble_scheduler::{Module, Call, Storage, Event<T>} = 1,

		// Must be before session.
		Babe: noble_babe::{Module, Call, Storage, Config, Inherent, ValidateUnsigned} = 2,

		Timestamp: noble_timestamp::{Module, Call, Storage, Inherent} = 3,
		Indices: noble_indices::{Module, Call, Storage, Config<T>, Event<T>} = 4,
		Balances: noble_balances::{Module, Call, Storage, Config<T>, Event<T>} = 5,
		TransactionPayment: noble_transaction_payment::{Module, Storage} = 32,

		// Consensus support.
		Authorship: noble_authorship::{Module, Call, Storage} = 6,
		Staking: noble_staking::{Module, Call, Storage, Config<T>, Event<T>, ValidateUnsigned} = 7,
		Offences: noble_offences::{Module, Call, Storage, Event} = 8,
		Historical: session_historical::{Module} = 33,
		Session: noble_session::{Module, Call, Storage, Event, Config<T>} = 9,
		Grandpa: noble_grandpa::{Module, Call, Storage, Config, Event, ValidateUnsigned} = 11,
		ImOnline: noble_im_online::{Module, Call, Storage, Event<T>, ValidateUnsigned, Config<T>} = 12,
		AuthorityDiscovery: noble_authority_discovery::{Module, Call, Config} = 13,

		// Governance stuff.
		Democracy: noble_democracy::{Module, Call, Storage, Config, Event<T>} = 14,
		Council: noble_collective::<Instance1>::{Module, Call, Storage, Origin<T>, Event<T>, Config<T>} = 15,
		TechnicalCommittee: noble_collective::<Instance2>::{Module, Call, Storage, Origin<T>, Event<T>, Config<T>} = 16,
		ElectionsPhragmen: noble_elections_phragmen::{Module, Call, Storage, Event<T>, Config<T>} = 17,
		TechnicalMembership: noble_membership::<Instance1>::{Module, Call, Storage, Event<T>, Config<T>} = 18,
		Treasury: noble_treasury::{Module, Call, Storage, Config, Event<T>} = 19,

		// Claims. Usable initially.
		Claims: claims::{Module, Call, Storage, Event<T>, Config<T>, ValidateUnsigned} = 24,
		// Vesting. Usable initially, but removed once all vesting is finished.
		Vesting: noble_vesting::{Module, Call, Storage, Event<T>, Config<T>} = 25,
		// Cunning utilities. Usable initially.
		Utility: noble_utility::{Module, Call, Event} = 26,

		// Identity. Late addition.
		Identity: noble_identity::{Module, Call, Storage, Event<T>} = 28,

		// Proxy module. Late addition.
		Proxy: noble_proxy::{Module, Call, Storage, Event<T>} = 29,

		// Multisig dispatch. Late addition.
		Multisig: noble_multisig::{Module, Call, Storage, Event<T>} = 30,

		// Bounties module.
		Bounties: noble_bounties::{Module, Call, Storage, Event<T>} = 34,

		// Tips module.
		Tips: noble_tips::{Module, Call, Storage, Event<T>} = 35,
