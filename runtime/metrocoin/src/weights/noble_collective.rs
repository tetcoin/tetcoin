...
//! Autogenerated weights for noble_collective
//!
...
/// Weight functions for noble_collective.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: fabric_system::Config> noble_collective::WeightInfo for WeightInfo<T> {
